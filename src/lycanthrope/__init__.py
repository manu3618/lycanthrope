...
DESCR = {
    "tanneur": "Le but du taneur est de mourir.",
    "chasseur": (
    ...
    "loup garou": (
        ...
        "Si l'un d'entre eux meurt, ils ne gagnent pas. "
    ...
    "franc maçon": (
        "Villageois comme les autres. "
        "Lors de son tour, ils prennent connaissance de l'identité "
        "des autres franc-maçon."
    ),
    "voyante": (
        "Villageoise. Elle prends connaissance "
        "du rôle de n'importe quel autre joueur ou de 2 cartes du centre."
    ),
    "voleur": (
